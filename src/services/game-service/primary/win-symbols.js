 ...
 * **********************************************************************************************************************************************************************
 * */
const SYMBOLS_W01 = ["JD", "JD", "JD"];
const SYMBOLS_W02 = ["T1", "T1", "T1"];
const SYMBOLS_W03 = ["T2", "T2", "T2"];
const SYMBOLS_W04 = ["T3", "T3", "T3"];
...
const SYMBOLS_W12 = ["T4", "T4", "T4"]; //SECG-5001["T4","T4","T4"] SIX OF EIGHTEEN
...
const SYMBOLS_W23 = ["T5", "T5", "T5"]; //SECG-5002["T5","T5","T5"] HIT OR MISS
...
const SYMBOLS_W32 = ["*", "*", "GC"]; //SECG-5003["*","*","GC"] RANDOM

const SYMBOLS_W33 = ["A7", "A7", "2X"];
const SYMBOLS_W34 = ["A7", "A7", "A7"];
const SYMBOLS_W35 = ["A7", "A7", "WI"];
const SYMBOLS_W36 = ["*", "*", "T6"]; //SECG-5004["*","*","T6"] ONE OF THREE
...
const SYMBOLS_W43 = ["*", "*", "WH"]; //SECG-5005["*","*","WH"] MONEY WHEEL
